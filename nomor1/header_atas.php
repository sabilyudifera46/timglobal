...
<nav class="navbar navbar-expand-lg navbar-dark" id="header_atas_s">
    ...
    <button class="navbar-toggler" type="button" style="border:none !important;" data-bs-toggle="collapse" onclick="openNav()" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <ul class="navbar-nav" style="margin: auto;">
            <li class="nav-item">
            <a class="navbar-brand" href="<?php echo $path ?>index.php"><img src="<?php echo $path ?>Image/logokotasurabaya.png" class="d-inline-block align-top" alt="" width="200" height="50"></a>
            ...
            <li class="nav-item">
            <a class="nav-link" href="<?php echo $path ?>login.php"> <img src="Image/search2.png"  alt="Flowers in Chania"> </a>
            </li>
        </ul>
        </div>
    </div>
