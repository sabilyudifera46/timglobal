...
<div class="container" style="border-style: outset; border-color: #DDDDDD;">
  <div class="row">
    <div class="col-md-6" style="height: 400px;background-position: center;  padding-top: 1.5%;background-image: url('Image/IMG_3570.JPG'); background-repeat: no-repeat;background-size: 70% 100%;">
    </div>
    <div class="col-md-6">
...
<div style="background-image: url('Image/grdgfdgdf.png'); background-size: 100% 60%; background-repeat: no-repeat;">
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6" style="height: 400px; background-color:darkgrey ; padding-top: 1.5%;background-image: url('Image/IMG_3570.JPG'); background-size: cover;">
    </div>
  </div>
</div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col" id="awersome" style="height: 300px; background-color:darkgrey ; padding-top: 1.5%;background-image: url('Image/IMG_3570.JPG'); background-size: cover;">
    ...
    <div class="col" id="awersome" style="height: 300px; background-color:darkgrey ; padding-top: 1.5%;background-image: url('Image/IMG_3571.JPG'); background-size: cover;">
        <div class="container22">
            <div class="overlay">
                <div class="text">VIEW</div>
            </div>
    ...
    <div class="col" id="awersome" style="height: 300px; background-color:darkgrey ; padding-top: 1.5%;background-image: url('Image/IMG_3572.JPG'); background-size: cover;">
        <div class="container22">
            <div class="overlay">
                <div class="text">VIEW</div>
            </div>
